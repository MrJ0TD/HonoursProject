...
<body>
        ...
        <li><a href="index.php">Home</a></li>
         <li class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu">
            ...
            <li class="active"><a href="nintendo.php">Nintendo</a></li>
  ...
  <div id="post" class="col-lg-10 ">  
   ...
   <h1 class='text-center'>Xbox</h1>
	<p class='text-center'>Below is a list of Users who all love Nintendo!</p>
</div>
     </div>
...
$users = DB::getInstance()->query("SELECT * FROM users WHERE console LIKE '%Nintendo%'");

if(!$users->count()){
  echo 'Nobody seems to like Nintendo!';
} else {
