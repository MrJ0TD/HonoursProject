...
<body>
  ...
  <div id="post" class="col-lg-10 ">  
   ...
   <h1 class='text-center'>Xbox</h1>
	<p class='text-center'>Below is a list of Users who all love the Xbox!</p>
</div>
     </div>
...
$users = DB::getInstance()->query("SELECT * FROM users WHERE console LIKE '%Xbox%'");

if(!$users->count()){
  echo 'Nobody seems to like the Xbox!';
} else {
