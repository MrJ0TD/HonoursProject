...
<body>
      ...
      <ul class="nav navbar-nav navbar-right" >
        <li><a href="index.php">Home</a></li>
         <li class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu">
            <li class="active"><a href="playstation.php">Playstation</a></li>
  ...
  <div id="post" class="col-lg-10 ">  
   ...
   <h1 class='text-center'>Playstation</h1>
	<p class='text-center'>Below is a list of Users who all love the Playstation!</p>
</div>
     </div>
...
$users = DB::getInstance()->query("SELECT * FROM users WHERE console LIKE '%Playstation%'");

if(!$users->count()){
  echo 'Nobody seems to like the Playstation!';
} else {
